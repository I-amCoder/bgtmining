...
<div class="sell-card">
    <div class="sell-card__buttons d-flex gap-2">
        <button class="buy--sell-tab btn btn--danger @if($type == 2 ) active @endif" data-type="2"><b>@lang('Sell Coin')</b></button>
        <button class="buy--sell-tab btn btn--success  @if($type == 1 ) active @endif" data-type="1"><b>@lang('Buy Coin')</b></button>
    </div>
