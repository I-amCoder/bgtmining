...
class AdvertisementController extends Controller
{
    ...
    public function create()
    {
        ...
        return view($this->activeTemplate . 'user.advertisement.create', compact('pageTitle', 'cryptos', 'fiatGateways', 'paymentWindows', 'isPermitted', 'fiatCurrencies', 'step', 'advertisement'));
    }
    ...
    public function edit($id)
    {
        ...
        return view($this->activeTemplate . 'user.advertisement.edit', compact('pageTitle', 'advertisement', 'cryptos', 'fiatGateways', 'paymentWindows', 'step', 'fiatCurrencies'));
    }
