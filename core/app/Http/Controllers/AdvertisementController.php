...
class AdvertisementController extends Controller
{
    ...
    public function allAds($type, $crypto, $country = null, $gateway = null, $currency = null, $amount = null)
    {
        ...
        if (request()->ajax()) {
            ...
            $html     = view($this->activeTemplate . "advertisement.$type", compact('ads'))->render();
        ...
        return view($this->activeTemplate . 'advertisement.all', compact('pageTitle', 'advertisements', 'type', 'crypto', 'cryptos', 'fiatGateways', 'countries','request'));
    }
}
